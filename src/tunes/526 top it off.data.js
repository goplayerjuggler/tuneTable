...
N: A and B parts are played straight.
N: 
K:Dmajor
|:B|A2F~F3d2A|Bcde2cd2B|A2F~F3d2A|[M:12/8]Bcd A2F D2A D2B|
 [M:9/8]A2F~F3d2A|Bcde2cd2B|A2F~F3d2A|[M:12/8]BcdA2FD2AD2:|
 g|: [M:9/8]f2dd2cd2f|e2=cc2Bc2e|d2BB2AB2d|c2AA2GA2g|
 f2dd2cd2f|e2=cc2Bc2e|d2A Bcde2c| [1 [M:6/8]d3-d2 e :|2 [M:6/8]d3-d2!D.C.! |]  `,
	theSessionId: 2608,
	theSessionSettingId: 23345,
	references: [
		{
			artists: "Brian Hughes, whistle",
	...
	crossReferences: [
		{
			theSessionId: 1374,
			index: 1
			// Cucanandy/Top it Off/The Sunny Banks - S Barou, B Harper
		}
	]
};
